...
@WebServlet(name = "AdminLoginServlet", urlPatterns = {"/do.adminlogin"})
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (username == null || username.isEmpty() || password == null || password.isEmpty()){
            response.sendRedirect("Admin/admin_login.jsp?error=ERROR: Please input valid inputs.");
            return;
        }
        ...
        if (users == null || users.isEmpty()){
            response.sendRedirect("Admin/admin_login.jsp?error=ERROR: Please create an account first.");
            return;
        } else{
            for (User i : users){
            ...
            if (username_exists == false){
                response.sendRedirect("Admin/admin_login.jsp?error=ERROR: Your username and/or password is invalid.");
                return;
            }
            else {
